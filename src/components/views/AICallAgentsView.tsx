...
export function AICallAgentsView() {
          ...
          <div id="demo" className="max-w-4xl mx-auto bg-white rounded-3xl border border-[#E7E7E4] p-6 sm:p-10 shadow-xl space-y-6">
            <div className="flex items-center justify-between pb-4 border-b border-[#E7E7E4]">
              ...
              <button
                ...
                className="px-4 py-1.5 rounded-full bg-[#F7F7F5] border border-[#E7E7E4] text-xs font-semibold text-neutral-700 hover:bg-neutral-100 transition-colors cursor-pointer"
              >
